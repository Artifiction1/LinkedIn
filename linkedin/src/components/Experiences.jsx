  ...
  return (
    <div className="experiences">
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            onClick={async ()=>{await FetchExperiences('POST'); FetchExperiences('GET');handleClose()}}
            >
            save
          </Button>
        </Modal.Footer>
         ...
         {toggle === false && (
          <div className="m-1 ml-4 d-flex flex-column text-left">
            ...
            <span id="eduFontSize" className="text-muted">
              {exp.startDate.substr(0, 10)} - {exp.endDate !== undefined && (<span>{exp.endDate.substr(0, 10)}</span>)} {exp.endDate === undefined &&(<span>now</span>)}
            </span>
