              ...
              return (
                <div className="news-feed d-flex flex-column">
                  {current.user._id === '62cbecece6c0300015918143' && (<>
                    <button onClick={handleShow} className="align-self-end"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-three-dots" viewBox="0 0 16 16">
                  ...
                  <div className="main-section">
                    <div className="top-part">
                      <div >
                        <img className="small-img" src={current.user.image} /> <span>{current.username} </span>
                      </div>

                      <div className="blue-follow"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-plus" viewBox="0 0 16 16">
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
                      </svg><span>Follow</span></div>
                    </div>
                    <div>
                      {current.text}
                    </div>
                    <div> <img className="img-body" src={current.user.image} />
                    </div>
                  </div>
                  ...
                  <div className="d-flex bottom-icons">
                    <div >
                      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                    ...
                    <div >
                      <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-chat-text" viewBox="0 0 16 16">
                    ...
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-arrow-90deg-right" viewBox="0 0 16 16">
                    ...
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-send-fill" viewBox="0 0 16 16">
